...
/* Test class to show use of Less Than condition in use (Task 1) */
public class ExampleTestLessThan {
...
//		showTables();
	...
	public static void insertData() {
		...
		executeStatement(
				new Insert(
						"contact", 
						new String[] {"name", "email"}, 
						new String[] {"Phoebe", "phoebe.myers@friends.us"}
				)
		);
	}
	...
	/* Test method to select rows that satisfy the Less Than condition */
	public static void selectRowsWithLessThan(){
