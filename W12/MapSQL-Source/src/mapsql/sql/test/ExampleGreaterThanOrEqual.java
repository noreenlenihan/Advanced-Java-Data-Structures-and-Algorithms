...
/* Test class for Greater Than Or Equal to condition (Task 1) */
public class ExampleGreaterThanOrEqual {
	...
	public static void main(String[] args) {
		...
		insertData();
		selectTable();
		selectRowsWithGreaterThanOrEqual();
...
//		showTables();
	...
	public static void insertData() {
		...
		executeStatement(
				new Insert(
						"contact", 
						new String[] {"name", "email"}, 
						new String[] {"Monica", "monica.gellar@ucd.ie"}
				)
		);
		executeStatement(
				new Insert(
	...
	/* Method to test implementation of SQL restriction using Greater Than Or Equal to clause */
	public static void selectRowsWithGreaterThanOrEqual(){
		executeStatement(new Select("contact", new String[] {"id", "name", "email"}, new GreaterThanOrEqual("id", "2")));
	}
}