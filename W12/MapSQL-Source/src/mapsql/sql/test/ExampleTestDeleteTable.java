...
/* Test class for testing deleting rows from a table (Task 4) */
public class ExampleTestDeleteTable {
...
//		showTables();
	...
	public static void selectTableAfterDelete() {
		executeStatement(new Select("contact", new String[] { "name" }));
	}
	...
	public static void insertData() {
		...
		executeStatement(
				new Insert(
						"contact", 
						new String[] {"name", "email"}, 
						new String[] {"Sylvester", "sylvester.demo@ucd.ie"}
				)
		);
	}
	...
	public static void updateData() {
		...
		executeStatement(
				new Update(
						...
						new String[] {"23", "Henrietta", "henry.mcloughlin@ucd.ie"}, 
	...
	public static void updateOrData() {
		executeStatement(
				new Update(
						"contact", 
						new String[] {"email"}, 
						new String[] {"xhenry.mcloughlin@ucd.ie"}, 
						new OrCondition(
								new Equals("id", "2"), 
								new Equals("id", "3")
						)
	...
	public static void deleteData() {
		System.out.println("Deleting the Henriettas..");
		executeStatement(new Delete("contact", new Equals("id", "23")));
	}
