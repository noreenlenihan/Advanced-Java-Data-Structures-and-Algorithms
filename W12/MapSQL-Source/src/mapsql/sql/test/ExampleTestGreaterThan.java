...
public class ExampleTestGreaterThan {
...
//		showTables();
	...
	public static void insertData() {
		...
		executeStatement(
				new Insert(
						"contact", 
						new String[] {"name", "email"}, 
						new String[] {"Chandler", "chandler.bing@centralpark.us"}
				)
		);
	}
	...
	public static void selectRowsWithGreaterThan(){
		//Test for selecting rows with a greater than condition (Task 1)
		executeStatement(new Select("contact", new String[] {"id", "name", "email"}, new GreaterThan("id", "1")));
	}
}
